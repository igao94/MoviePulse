...
namespace Persistence.Migrations
{
    ...
    [Migration("20250601084030_UserMoveInteractionEntityAdded")]
    partial class UserMoveInteractionEntityAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.UserMovieInteraction", b =>
                {
                    ...
                    b.Property<DateTime?>("AddedToWatchlistAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Entities.UserMovieInteraction", b =>
                {
                    b.HasOne("Domain.Entities.Movie", "Movie")
                        .WithMany("UserMovieInteractions")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
